...
We tested the hypothesis that routine clinical anatomic localization was no different than quantitative image-derived localization utilizing registration-based techniques and atlas-based labeling.
